...
export interface WideHorizontalUserProfileExampleProps {
  className?: string;
}

export function WideHorizontalUserProfileExample({ className }: WideHorizontalUserProfileExampleProps) {
