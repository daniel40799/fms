...
export interface ActionableDescriptionListProps {
  className?: string;
}

export function ActionableDescriptionList({ className }: ActionableDescriptionListProps) {
  return (
    <>
...
export default ActionableDescriptionList;