...
export interface WithRecommendationsGridProps {
  people?: PersonItem[];
  className?: string;
}

export function WithRecommendationsGrid({
  people = [],
  className,
}: WithRecommendationsGridProps) {
  return (
...
export default WithRecommendationsGrid;