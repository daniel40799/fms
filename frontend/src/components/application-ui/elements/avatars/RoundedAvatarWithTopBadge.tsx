...
export interface RoundedAvatarWithTopBadgeProps {
  className?: string;
}

export function RoundedAvatarWithTopBadge({ className }: RoundedAvatarWithTopBadgeProps) {
  return (
    <>
...
export default RoundedAvatarWithTopBadge;