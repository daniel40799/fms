...
export interface CircularAvatarWithTopBadgeProps {
  className?: string;
}

export function CircularAvatarWithTopBadge({ className }: CircularAvatarWithTopBadgeProps) {
  return (
    <>
...
export default CircularAvatarWithTopBadge;