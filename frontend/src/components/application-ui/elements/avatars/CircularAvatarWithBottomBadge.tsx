...
export interface CircularAvatarWithBottomBadgeProps {
  className?: string;
}

export function CircularAvatarWithBottomBadge({ className }: CircularAvatarWithBottomBadgeProps) {
  return (
    <>
...
export default CircularAvatarWithBottomBadge;