...
export interface SmallFlatPillBadgeWithDotProps {
  className?: string;
}

export function SmallFlatPillBadgeWithDot({ className }: SmallFlatPillBadgeWithDotProps) {
  return (
    <>
...
export default SmallFlatPillBadgeWithDot;