...
export interface BorderBadgeWithDotDarkProps {
  className?: string;
}

export function BorderBadgeWithDotDark({ className }: BorderBadgeWithDotDarkProps) {
  return (
    <>
...
export default BorderBadgeWithDotDark;