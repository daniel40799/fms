...
export interface SmallFlatBadgeWithDotProps {
  className?: string;
}

export function SmallFlatBadgeWithDot({ className }: SmallFlatBadgeWithDotProps) {
  return (
    <>
...
export default SmallFlatBadgeWithDot;