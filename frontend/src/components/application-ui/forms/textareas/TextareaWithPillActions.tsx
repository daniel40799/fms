...
export interface TextareaWithPillActionsProps {
...
export function TextareaWithPillActions({
  assignees = [],
  labels = [],
  dueDates = [],
  className,
}: TextareaWithPillActionsProps) {
...
export default TextareaWithPillActions;