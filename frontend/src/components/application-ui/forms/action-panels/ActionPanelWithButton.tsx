...
export interface ActionPanelWithButtonProps {
  className?: string;
}

export function ActionPanelWithButton({ className }: ActionPanelWithButtonProps) {
  return (
...
export default ActionPanelWithButton;