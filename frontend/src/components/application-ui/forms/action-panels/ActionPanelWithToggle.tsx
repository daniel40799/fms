...
export interface ActionPanelWithToggleProps {
  className?: string;
}

export function ActionPanelWithToggle({ className }: ActionPanelWithToggleProps) {
...
export default ActionPanelWithToggle;