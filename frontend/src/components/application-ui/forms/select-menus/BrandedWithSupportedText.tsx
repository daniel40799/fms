...
export interface BrandedWithSupportedTextProps {
  publishingOptions?: PublishingoptionItem[];
  className?: string;
}

export function BrandedWithSupportedText({
  publishingOptions = [],
  className,
...
export default BrandedWithSupportedText;