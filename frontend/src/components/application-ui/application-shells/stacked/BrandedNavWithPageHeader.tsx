...
export interface BrandedNavWithPageHeaderProps {
  user?: UserProfile;
  navigation?: NavItem[];
...
export function BrandedNavWithPageHeader({
  user,
  navigation = [],
  userNavigation = [],
  className,
}: BrandedNavWithPageHeaderProps) {
...
export default BrandedNavWithPageHeader;