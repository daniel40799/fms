...
export interface FullWidthThreeColumnLayoutProps {
  navigation?: NavItem[];
  teams?: TeamItem[];
  className?: string;
}

export function FullWidthThreeColumnLayout({
  navigation = [],
  teams = [],
  className,
}: FullWidthThreeColumnLayoutProps) {
...
export default FullWidthThreeColumnLayout;