...
export interface FullWidthWithRightColumnProps {
  navigation?: NavItem[];
  teams?: TeamItem[];
  className?: string;
}

export function FullWidthWithRightColumn({
  navigation = [],
  teams = [],
  className,
}: FullWidthWithRightColumnProps) {
...
export default FullWidthWithRightColumn;