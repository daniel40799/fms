...
export interface WithMetaActionsAndBreadcrumbsOnDarkProps {
  className?: string;
}

export function WithMetaActionsAndBreadcrumbsOnDark({ className }: WithMetaActionsAndBreadcrumbsOnDarkProps) {
  return (
...
export default WithMetaActionsAndBreadcrumbsOnDark;