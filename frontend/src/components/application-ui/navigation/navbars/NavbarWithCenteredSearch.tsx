...
export interface NavbarWithCenteredSearchProps {
  user?: UserProfile;
  navigation?: NavItem[];
...
export function NavbarWithCenteredSearch({
  user,
  navigation = [],
  userNavigation = [],
  className,
}: NavbarWithCenteredSearchProps) {
...
export default NavbarWithCenteredSearch;