...
export interface DarkNavbarWithCenteredSearchProps {
  user?: UserProfile;
  navigation?: NavItem[];
...
export function DarkNavbarWithCenteredSearch({
  user,
  navigation = [],
  userNavigation = [],
  className,
}: DarkNavbarWithCenteredSearchProps) {
...
export default DarkNavbarWithCenteredSearch;