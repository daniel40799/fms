...
export interface StorefrontPageWithTestimonialsProps {
...
export function StorefrontPageWithTestimonials({
  currencies = [],
  navigation,
  offers = [],
  trendingProducts = [],
  ...
  footerNavigation,
  className,
}: StorefrontPageWithTestimonialsProps) {
...
export default StorefrontPageWithTestimonials;