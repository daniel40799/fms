...
export interface StorefrontPageWithFeaturesProps {
...
export function StorefrontPageWithFeatures({
  navigation,
  favorites = [],
  footerNavigation,
  className,
}: StorefrontPageWithFeaturesProps) {
...
export default StorefrontPageWithFeatures;