...
export interface OrderDetailPageSimpleProgressProps {
...
export function OrderDetailPageSimpleProgress({
  currencies = [],
  navigation,
  products = [],
  footerNavigation,
  className,
}: OrderDetailPageSimpleProgressProps) {
...
export default OrderDetailPageSimpleProgress;