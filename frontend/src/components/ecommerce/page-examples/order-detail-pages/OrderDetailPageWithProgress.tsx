...
export interface OrderDetailPageWithProgressProps {
...
export function OrderDetailPageWithProgress({
  currencies = [],
  navigation,
  products = [],
  footerNavigation,
  className,
}: OrderDetailPageWithProgressProps) {
...
export default OrderDetailPageWithProgress;