...
export interface CategoryPageWithDetailGridProps {
...
export function CategoryPageWithDetailGrid({
  navigation,
  breadcrumbs = [],
  filters = [],
  products = [],
  footerNavigation,
  className,
}: CategoryPageWithDetailGridProps) {
...
export default CategoryPageWithDetailGrid;