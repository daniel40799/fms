...
export interface CategoryPageWithFilterSidebarProps {
...
export function CategoryPageWithFilterSidebar({
  navigation,
  sortOptions = [],
  subCategories = [],
  filters = [],
  ...
  footerNavigation,
  className,
}: CategoryPageWithFilterSidebarProps) {
...
export default CategoryPageWithFilterSidebar;