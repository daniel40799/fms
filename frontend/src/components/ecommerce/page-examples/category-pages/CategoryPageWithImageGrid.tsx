...
export interface Products1Item {
  id: number;
  name: string;
  href: string;
  price: string;
...
export interface Products2Item {
  id: number;
  name: string;
  href: string;
  price: string;
...
export interface CategoryPageWithImageGridProps {
  currencies?: CurrencieItem[];
  navigation?: NavigationMap;
  sortOptions?: SortoptionItem[];
  filters?: FilterItem[];
  products1?: Products1Item[];
  products2?: Products2Item[];
  footerNavigation?: FooternavigationItem;
  className?: string;
}

export function CategoryPageWithImageGrid({
  currencies = [],
  navigation,
  sortOptions = [],
  filters = [],
  ...
  footerNavigation,
  className,
}: CategoryPageWithImageGridProps) {
...
export default CategoryPageWithImageGrid;