...
export interface CategoryPageWithSimpleGridProps {
...
export function CategoryPageWithSimpleGrid({
  currencies = [],
  navigation,
  breadcrumbs = [],
  sortOptions = [],
  ...
  footerNavigation,
  className,
}: CategoryPageWithSimpleGridProps) {
...
export default CategoryPageWithSimpleGrid;