...
export interface ProductPageWithTabsAndRelatedProps {
...
export function ProductPageWithTabsAndRelated({
  navigation,
  product,
  reviews = [],
  faqs = [],
  ...
  footerNavigation,
  className,
}: ProductPageWithTabsAndRelatedProps) {
...
export default ProductPageWithTabsAndRelated;