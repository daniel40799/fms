...
export interface ShoppingCartPageWithRelatedProps {
...
export function ShoppingCartPageWithRelated({
  navigation,
  products = [],
  relatedProducts = [],
  footerNavigation,
  className,
}: ShoppingCartPageWithRelatedProps) {
...
export default ShoppingCartPageWithRelated;