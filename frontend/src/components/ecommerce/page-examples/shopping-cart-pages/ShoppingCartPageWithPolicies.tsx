...
export interface ShoppingCartPageWithPoliciesProps {
...
export function ShoppingCartPageWithPolicies({
  navigation,
  products = [],
  policies = [],
  footerNavigation,
  className,
}: ShoppingCartPageWithPoliciesProps) {
...
export default ShoppingCartPageWithPolicies;