...
export interface OrderHistoryPageWithInvoiceTablesProps {
...
export function OrderHistoryPageWithInvoiceTables({
  currencies = [],
  navigation,
  orders = [],
  footerNavigation,
  className,
}: OrderHistoryPageWithInvoiceTablesProps) {
...
export default OrderHistoryPageWithInvoiceTables;