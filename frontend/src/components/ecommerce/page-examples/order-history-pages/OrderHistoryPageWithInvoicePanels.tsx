...
export interface OrderHistoryPageWithInvoicePanelsProps {
...
export function OrderHistoryPageWithInvoicePanels({
  navigation,
  orders = [],
  footerNavigation,
  className,
...
export default OrderHistoryPageWithInvoicePanels;