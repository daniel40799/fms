...
export interface OrderHistoryPageWithInvoiceListProps {
...
export function OrderHistoryPageWithInvoiceList({
  navigation,
  orders = [],
  footerNavigation,
  className,
}: OrderHistoryPageWithInvoiceListProps) {
...
export default OrderHistoryPageWithInvoiceList;