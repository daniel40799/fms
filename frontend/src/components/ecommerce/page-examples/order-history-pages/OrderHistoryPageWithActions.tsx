...
export interface OrderHistoryPageWithActionsProps {
...
export function OrderHistoryPageWithActions({
  currencies = [],
  navigation,
  orders = [],
  footerNavigation,
  className,
}: OrderHistoryPageWithActionsProps) {
...
export default OrderHistoryPageWithActions;