...
export interface WithHeaderImagesAndDescriptionsProps {
  className?: string;
}

export function WithHeaderImagesAndDescriptions({ className }: WithHeaderImagesAndDescriptionsProps) {
  return (
...
export default WithHeaderImagesAndDescriptions;