...
export interface WithOrderSummarySidebarProps {
  discount?: DiscountItem;
  products?: ProductItem[];
  className?: string;
}

export function WithOrderSummarySidebar({
  discount,
  products = [],
  className,
}: WithOrderSummarySidebarProps) {
...
export default WithOrderSummarySidebar;