...
export interface WithColorSelectorSizeSelectorAndDetailsLinkProps {
  product?: ProductItem;
  className?: string;
}

export function WithColorSelectorSizeSelectorAndDetailsLink({
  product,
  className,
}: WithColorSelectorSizeSelectorAndDetailsLinkProps) {
...
export default WithColorSelectorSizeSelectorAndDetailsLink;