...
export interface ProductQuickViewWithSelectorProps {
  product?: ProductItem;
  className?: string;
}

export function ProductQuickViewWithSelector({
  product,
  className,
}: ProductQuickViewWithSelectorProps) {
...
export default ProductQuickViewWithSelector;