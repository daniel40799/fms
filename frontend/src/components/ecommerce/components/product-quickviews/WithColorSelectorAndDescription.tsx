...
export interface WithColorSelectorAndDescriptionProps {
  product?: ProductItem;
  className?: string;
}

export function WithColorSelectorAndDescription({
  product,
  className,
}: WithColorSelectorAndDescriptionProps) {
...
export default WithColorSelectorAndDescription;