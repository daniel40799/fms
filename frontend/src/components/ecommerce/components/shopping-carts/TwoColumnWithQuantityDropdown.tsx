...
export interface TwoColumnWithQuantityDropdownProps {
  products?: ProductItem[];
  className?: string;
}

export function TwoColumnWithQuantityDropdown({
  products = [],
  className,
}: TwoColumnWithQuantityDropdownProps) {
  return (
...
export default TwoColumnWithQuantityDropdown;