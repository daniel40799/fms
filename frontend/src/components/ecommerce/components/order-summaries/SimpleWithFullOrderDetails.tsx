...
export interface SimpleWithFullOrderDetailsProps {
  products?: ProductItem[];
  className?: string;
}

export function SimpleWithFullOrderDetails({
  products = [],
  className,
}: SimpleWithFullOrderDetailsProps) {
  return (
...
export default SimpleWithFullOrderDetails;