...
export interface WithDropdownProductFiltersProps {
...
export function WithDropdownProductFilters({
  sortOptions = [],
  filters = [],
  activeFilters = [],
  className,
}: WithDropdownProductFiltersProps) {
...
export default WithDropdownProductFilters;