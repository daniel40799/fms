...
export interface WithCenteredTextAndDropdownProductFiltersProps {
  sortOptions?: SortoptionItem[];
  filters?: FilterItem[];
  className?: string;
}

export function WithCenteredTextAndDropdownProductFilters({
  sortOptions = [],
  filters = [],
  className,
...
export default WithCenteredTextAndDropdownProductFilters;