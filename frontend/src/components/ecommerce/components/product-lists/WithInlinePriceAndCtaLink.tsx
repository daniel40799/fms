...
export interface WithInlinePriceAndCtaLinkProps {
  products?: ProductItem[];
  className?: string;
}

export function WithInlinePriceAndCtaLink({
  products = [],
  className,
}: WithInlinePriceAndCtaLinkProps) {
  return (
...
export default WithInlinePriceAndCtaLink;