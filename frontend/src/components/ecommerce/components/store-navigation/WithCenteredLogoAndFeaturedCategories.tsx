...
export interface WithCenteredLogoAndFeaturedCategoriesProps {
  navigation?: NavigationMap;
  className?: string;
}

export function WithCenteredLogoAndFeaturedCategories({
  navigation,
  className,
}: WithCenteredLogoAndFeaturedCategoriesProps) {
...
export default WithCenteredLogoAndFeaturedCategories;