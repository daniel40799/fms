...
export interface WithDoubleColumnAndPersistentMobileNavProps {
  navigation?: NavigationMap;
  className?: string;
}

export function WithDoubleColumnAndPersistentMobileNav({
  navigation,
  className,
...
export default WithDoubleColumnAndPersistentMobileNav;