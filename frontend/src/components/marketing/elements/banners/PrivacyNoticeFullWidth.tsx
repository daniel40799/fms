...
export interface PrivacyNoticeFullWidthProps {
  className?: string;
}

export function PrivacyNoticeFullWidth({ className }: PrivacyNoticeFullWidthProps) {
  return (
...
export default PrivacyNoticeFullWidth;