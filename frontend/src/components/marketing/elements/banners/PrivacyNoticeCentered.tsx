...
export interface PrivacyNoticeCenteredProps {
  className?: string;
}

export function PrivacyNoticeCentered({ className }: PrivacyNoticeCenteredProps) {
  return (
...
export default PrivacyNoticeCentered;