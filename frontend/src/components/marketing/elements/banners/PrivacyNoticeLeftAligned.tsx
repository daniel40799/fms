...
export interface PrivacyNoticeLeftAlignedProps {
  className?: string;
}

export function PrivacyNoticeLeftAligned({ className }: PrivacyNoticeLeftAlignedProps) {
  return (
...
export default PrivacyNoticeLeftAligned;