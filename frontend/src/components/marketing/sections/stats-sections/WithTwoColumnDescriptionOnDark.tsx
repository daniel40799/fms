...
export interface WithTwoColumnDescriptionOnDarkProps {
  stats?: StatItem[];
  className?: string;
}

export function WithTwoColumnDescriptionOnDark({
  stats = [],
  className,
}: WithTwoColumnDescriptionOnDarkProps) {
  return (
...
export default WithTwoColumnDescriptionOnDark;