...
export interface DarkFooterWithNewsletterBelowProps {
  navigation?: NavigationMap;
  className?: string;
}

export function DarkFooterWithNewsletterBelow({
  navigation,
  className,
}: DarkFooterWithNewsletterBelowProps) {
  return (
...
export default DarkFooterWithNewsletterBelow;