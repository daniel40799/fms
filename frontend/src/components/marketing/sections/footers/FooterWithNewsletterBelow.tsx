...
export interface FooterWithNewsletterBelowProps {
  navigation?: NavigationMap;
  className?: string;
}

export function FooterWithNewsletterBelow({
  navigation,
  className,
}: FooterWithNewsletterBelowProps) {
  void className;
  return (
...
export default FooterWithNewsletterBelow;