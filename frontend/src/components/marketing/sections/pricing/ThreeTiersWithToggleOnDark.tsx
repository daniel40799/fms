...
export interface ThreeTiersWithToggleOnDarkProps {
  frequencies?: FrequencieItem[];
  tiers?: PricingTier[];
  className?: string;
}

export function ThreeTiersWithToggleOnDark({
  frequencies = [],
  tiers = [],
  className,
}: ThreeTiersWithToggleOnDarkProps) {
...
export default ThreeTiersWithToggleOnDark;