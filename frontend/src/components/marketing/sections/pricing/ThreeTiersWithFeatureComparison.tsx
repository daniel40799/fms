...
export interface ThreeTiersWithFeatureComparisonProps {
  frequencies?: FrequencieItem[];
  tiers?: PricingTier[];
  sections?: SectionItem[];
  className?: string;
}

export function ThreeTiersWithFeatureComparison({
  frequencies = [],
  tiers = [],
  sections = [],
  className,
}: ThreeTiersWithFeatureComparisonProps) {
...
export default ThreeTiersWithFeatureComparison;