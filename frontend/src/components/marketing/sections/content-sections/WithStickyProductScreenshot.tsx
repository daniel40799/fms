...
export interface WithStickyProductScreenshotProps {
  className?: string;
}

export function WithStickyProductScreenshot({ className }: WithStickyProductScreenshotProps) {
  return (
...
export default WithStickyProductScreenshot;