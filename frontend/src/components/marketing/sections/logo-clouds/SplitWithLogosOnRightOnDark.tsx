...
export interface SplitWithLogosOnRightOnDarkProps {
  className?: string;
}

export function SplitWithLogosOnRightOnDark({ className }: SplitWithLogosOnRightOnDarkProps) {
  return (
...
export default SplitWithLogosOnRightOnDark;