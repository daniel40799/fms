...
export interface SimpleWithCallToActionProps {
  className?: string;
}

export function SimpleWithCallToAction({ className }: SimpleWithCallToActionProps) {
  return (
...
export default SimpleWithCallToAction;