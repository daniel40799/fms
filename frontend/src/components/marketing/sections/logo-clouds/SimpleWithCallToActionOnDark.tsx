...
export interface SimpleWithCallToActionOnDarkProps {
  className?: string;
}

export function SimpleWithCallToActionOnDark({ className }: SimpleWithCallToActionOnDarkProps) {
  return (
...
export default SimpleWithCallToActionOnDark;