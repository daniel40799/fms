...
export interface FeatureSectionWithPanelProps {
  features?: FeatureItem[];
  className?: string;
}

export function FeatureSectionWithPanel({
  features = [],
  className,
}: FeatureSectionWithPanelProps) {
  return (
...
export default FeatureSectionWithPanel;