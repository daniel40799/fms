...
export interface WithLargeScreenshotOnDarkProps {
  features?: FeatureItem[];
  className?: string;
}

export function WithLargeScreenshotOnDark({
  features = [],
  className,
}: WithLargeScreenshotOnDarkProps) {
  return (
...
export default WithLargeScreenshotOnDark;