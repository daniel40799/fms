...
export interface SimpleSideBySideOnBrandProps {
  className?: string;
}

export function SimpleSideBySideOnBrand({ className }: SimpleSideBySideOnBrandProps) {
  return (
...
export default SimpleSideBySideOnBrand;