...
export interface SecondaryfeatureItem {
  name: string;
  description: string;
  href: string;
  icon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
...
export interface WithMobileScreenshotAndTestimonialsGridProps {
  navigation?: NavItem[];
  primaryFeatures?: PrimaryfeatureItem[];
  secondaryFeatures?: SecondaryfeatureItem[];
  featuredTestimonial?: FeaturedtestimonialItem;
  testimonials?: TestimonialItem[];
  footerNavigation?: FooternavigationItem;
  className?: string;
}

export function WithMobileScreenshotAndTestimonialsGrid({
  navigation = [],
  primaryFeatures = [],
  secondaryFeatures = [],
  featuredTestimonial,
  ...
  footerNavigation,
  className,
}: WithMobileScreenshotAndTestimonialsGridProps) {
...
export default WithMobileScreenshotAndTestimonialsGrid;