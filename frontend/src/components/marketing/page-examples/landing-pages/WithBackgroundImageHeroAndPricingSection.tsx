...
export interface WithBackgroundImageHeroAndPricingSectionProps {
  navigation?: NavItem[];
...
export function WithBackgroundImageHeroAndPricingSection({
  navigation = [],
  features = [],
  tiers = [],
  faqs = [],
...
export default WithBackgroundImageHeroAndPricingSection;