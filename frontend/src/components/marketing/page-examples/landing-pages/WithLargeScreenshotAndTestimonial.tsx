...
export interface WithLargeScreenshotAndTestimonialProps {
  navigation?: NavItem[];
...
export function WithLargeScreenshotAndTestimonial({
  navigation = [],
  features = [],
  tiers = [],
  faqs = [],
...
export default WithLargeScreenshotAndTestimonial;