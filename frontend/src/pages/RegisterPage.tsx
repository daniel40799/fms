    ...
    <main className="grid min-h-screen bg-slate-50 lg:grid-cols-[1fr_520px]">
      ...
      <section className="flex items-center justify-center px-4 py-10">
        ...
        >
          ...
          <h2 className="mt-2 text-2xl font-semibold text-slate-950">Create an account</h2>
          <p className="mt-2 text-sm text-slate-600">Register as an end user to join events and manage your submissions.</p>
